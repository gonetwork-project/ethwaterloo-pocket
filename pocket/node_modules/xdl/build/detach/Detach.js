...
let prepareDetachedBuildAsync = exports.prepareDetachedBuildAsync = (() => {
  var _ref13 = _asyncToGenerator(function* (projectDir, args) {
    ...
    if (args.platform === 'ios') {
      ...
      if (!args.skipXcodeConfig) {
        ...
        yield (0, (_ExponentTools || _load_ExponentTools()).modifyIOSPropertyListAsync)(supportingDirectory, 'EXBuildConstants', function (constantsConfig) {
  ...
  return function prepareDetachedBuildAsync(_x32, _x33) {
